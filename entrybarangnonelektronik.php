...
<html lang="en">
	<head>
	    <title>Entry Barang Non-elektronik</title>
	    <meta charset="utf-8">
	...
	<body>
	    ...
	    <div class="container-fluid">
	    	<div class="jumbotron">
		    	<div class="row">
		    		<h1>Entry Barang Non-Elektronik</h1>
		    	</div>
				<hr>
		    	<div class="row">
		              		...
		              		<div class="form-group row">
			                	...
			                	<div class="col-sm-10">
			                  		<select class="form-control form-control-sm"  disabled>
			                    		<option name="jenisBarang">Non-Elektronik</option>
			                  		</select>
			                	</div>
			              	</div>
		              	</div>
		                	...
		                	<div class="col-sm-10">
		                  		...
		                  		<?php
									if(isset($_POST['action'])) {
										...
										$jenisBarang='non-elektronik';
										$keteranganBarang=$_POST['keteranganBarang'];
										$fotoBarang=$_POST['fotoBarang'];
										$usernameAdmin=$_SESSION['user'];
										$conn=connectDB();
										$insert="INSERT INTO BARANG VALUES ('$kodeBarang', '$namaBarang', '$jumlahBarang', '$jenisBarang','$keteranganBarang', '$fotoBarang', '$usernameAdmin')";
